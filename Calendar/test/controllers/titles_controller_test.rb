...
class TitlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create title" do
    assert_difference("Title.count") do
      post titles_url, params: { title: { description: @title.description, end_time: @title.end_time, start_time: @title.start_time } }
    end
  ...
  test "should update title" do
    patch title_url(@title), params: { title: { description: @title.description, end_time: @title.end_time, start_time: @title.start_time } }
